...
import { Orchestrator } from "@hallucinate/core";
import type { EngineAdapter, AgentSession, Task, Workspace, Role } from "@hallucinate/core";
...
let repo: string;
beforeEach(() => {
  repo = mkdtempSync(join(tmpdir(), "hallucinate-e2e-"));
